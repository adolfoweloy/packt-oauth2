...
public class JweTokenStore implements TokenStore {
    ...
    private JweTokenSerializer jweTokenSerializer;
    private String signKey;

    public JweTokenStore(String signKey,
            TokenStore delegate, JwtAccessTokenConverter converter,
            JweTokenSerializer jweTokenSerializer) {
        this.signKey = signKey;
        this.delegate = delegate;
        this.converter = converter;
        this.jweTokenSerializer = jweTokenSerializer;
    }
    ...
    private OAuth2AccessToken convertAccessToken(String tokenValue) {
        return converter.extractAccessToken(tokenValue, jweTokenSerializer.decode(signKey, tokenValue));
    }

    @Override
    public OAuth2Authentication readAuthentication(String token) {
        return converter.extractAuthentication(jweTokenSerializer.decode(signKey, token));
    }
